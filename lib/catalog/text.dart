    ...
    return Scaffold(
        ...
        body: ListView(children: <Widget>[
          ...
          Container(
            padding: const EdgeInsets.all(15),
            color: Colors.black12,
            child: const Text('Contoh Text Alignments'),
          ),
          Container(
            padding: const EdgeInsets.all(15),
            child: const Text(
          ...
          Container(
            padding: const EdgeInsets.all(15),
            child: const Text(
              "Text justify, Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including ver",
          ...
          Container(
            padding: const EdgeInsets.all(15),
            color: Colors.black12,
            child: const Text('Contoh Text Elipsis'),
          ),
          Container(
            padding: const EdgeInsets.all(15),
            child: const Text(
              'Text large, Flutter - Wrap text on overflow, like insert ellipsis or fade',
